...
<x-guest-layout>
    <div class="mx-auto flex h-full w-full max-w-[50rem] flex-col py-20">
        <div class="px-4 py-10 text-center sm:px-6 lg:px-8">
            <h1 class="block text-7xl font-bold text-gray-800 dark:text-white sm:text-9xl">403</h1>
            <h1 class="block text-2xl font-bold text-white"></h1>
            <p class="mt-3 text-gray-600 dark:text-gray-400">Forbidden.</p>
            <p class="text-gray-600 dark:text-gray-400">You don't have access to visit the page.</p>
