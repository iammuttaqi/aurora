        ...
        <div class="flex h-16 justify-between">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <div class="flex items-center justify-between gap-3">
                    @can('viewProductBox', \App\Models\Product::class)
                        <x-nav-link class="relative !block items-center justify-center gap-2 rounded-md border border-none border-transparent bg-blue-500 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:text-white hover:dark:text-white dark:focus:ring-offset-gray-800" href="{{ route('notifications.index') }}">
