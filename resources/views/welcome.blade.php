            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        class="scale-100 dark:bg-gray-800 dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none transition-all duration-250 hover:bg-gradient-to-r from-yellow-500 via-pink-500 to-red-500 p-0.5">
                        <div class="h-full w-full bg-white dark:bg-gray-800 p-6 flex rounded-lg">
                            <div>
                                <div
