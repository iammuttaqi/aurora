...
{{-- <div class="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
    <div>
        <div class="flex items-center">
            <svg class="h-6 w-6 stroke-gray-400" fill="none" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="mt-4 text-sm">
            <a class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300" href="https://laravel.com/docs">
                Explore the documentation

                <svg class="ml-1 h-5 w-5 fill-indigo-500 dark:fill-indigo-200" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
        <div class="flex items-center">
            <svg class="h-6 w-6 stroke-gray-400" fill="none" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" stroke-linecap="round" />
            </svg>
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <p class="mt-4 text-sm">
            <a class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300" href="https://laracasts.com">
