...
<input {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge(['class' => 'py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 read-only:bg-gray-100 read-only:cursor-not-allowed read-only:bg-gray-100 read-only:dark:bg-gray-700 disabled:cursor-not-allowed transition-all']) !!}>
