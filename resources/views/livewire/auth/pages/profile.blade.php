            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                ...
                <form class="grid grid-cols-1 gap-5 p-5 md:grid-cols-12" wire:submit.prevent="update" x-data="{
                    ...
                    <div class="col-span-6 flex flex-col gap-1">
                        ...
                        <div class="flex items-center">
                            <label class="dark:hover:bg-bray-800 flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 bg-contain bg-center bg-no-repeat transition hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600 sm:w-64" for="dropzone-file" style="background-image: url('@if ($logo) {{ $logo->temporaryUrl() }} @elseif($form['logo']) {{ asset($form['logo']) }} @endif')">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6" role="status" wire:loading wire:target="logo">
                        ...
                        <x-input-error class="mt-2" for="logo" />
                    </div>
                    ...
                    <div class="col-span-4 flex flex-col gap-1">
                        ...
                        <x-input :required="$this->required('form.contact_number_1')" :placeholder="$this->label('form.contact_number_1')" class="block w-full" id="contact_number_1" name="contact_number_1" type="text" wire:model.defer="form.contact_number_1" />
                        <x-input-error for="form.contact_number_1" />
                    </div>

                    <div class="col-span-4 flex flex-col gap-1">
                        <x-label :value="$this->label('form.contact_number_2')" for="contact_number_2" />
                        <x-input :required="$this->required('form.contact_number_2')" :placeholder="$this->label('form.contact_number_2')" class="block w-full" id="contact_number_2" name="contact_number_2" type="text" wire:model.defer="form.contact_number_2" />
                        <x-input-error for="form.contact_number_2" />
                    </div>

                    <div class="col-span-4 flex flex-col gap-1">
                        <x-label :value="$this->label('form.contact_number_3')" for="contact_number_3" />
                        <x-input :required="$this->required('form.contact_number_3')" :placeholder="$this->label('form.contact_number_3')" class="block w-full" id="contact_number_3" name="contact_number_3" type="text" wire:model.defer="form.contact_number_3" />
                        <x-input-error for="form.contact_number_3" />
                    </div>

                    <div class="col-span-4 flex flex-col gap-1">
                        <x-label :value="$this->label('form.email_1')" for="email_1" />
                        <x-input :required="$this->required('form.email_1')" :placeholder="$this->label('form.email_1')" class="block w-full" id="email_1" name="email_1" type="email" wire:model.defer="form.email_1" x-model="form.email_1" />
                        <x-input-error for="form.email_1" />
                    </div>

                    <div class="col-span-4 flex flex-col gap-1">
                        <x-label :value="$this->label('form.email_2')" for="email_2" />
                        <x-input :required="$this->required('form.email_2')" :placeholder="$this->label('form.email_2')" class="block w-full" id="email_2" name="email_2" type="email" wire:model.defer="form.email_2" x-model="form.email_2" />
                        <x-input-error for="form.email_2" />
                    </div>

                    <div class="col-span-4 flex flex-col gap-1">
                        <x-label :value="$this->label('form.email_3')" for="email_3" />
                        <x-input :required="$this->required('form.email_3')" :placeholder="$this->label('form.email_3')" class="block w-full" id="email_3" name="email_3" type="email" wire:model.defer="form.email_3" x-model="form.email_3" />
                    ...
                    <div class="col-span-3 flex flex-col gap-1">
                        ...
                        <x-input :required="$this->required('form.facebook')" :placeholder="$this->label('form.facebook')" class="block w-full" id="facebook" name="facebook" type="text" wire:model.defer="form.facebook" x-model="form.facebook" />
                        <x-input-error for="form.facebook" />
                    </div>

                    <div class="col-span-3 flex flex-col gap-1">
                        <x-label :value="$this->label('form.instagram')" for="instagram" />
                        <x-input :required="$this->required('form.instagram')" :placeholder="$this->label('form.instagram')" class="block w-full" id="instagram" name="instagram" type="text" wire:model.defer="form.instagram" x-model="form.instagram" />
                        <x-input-error for="form.instagram" />
                    </div>

                    <div class="col-span-3 flex flex-col gap-1">
                        <x-label :value="$this->label('form.twitter')" for="twitter" />
                        <x-input :required="$this->required('form.twitter')" :placeholder="$this->label('form.twitter')" class="block w-full" id="twitter" name="twitter" type="text" wire:model.defer="form.twitter" x-model="form.twitter" />
                        <x-input-error for="form.twitter" />
                    </div>

                    <div class="col-span-3 flex flex-col gap-1">
                        <x-label :value="$this->label('form.linkedin')" for="linkedin" />
                        <x-input :required="$this->required('form.linkedin')" :placeholder="$this->label('form.linkedin')" class="block w-full" id="linkedin" name="linkedin" type="text" wire:model.defer="form.linkedin" x-model="form.linkedin" />
                        <x-input-error for="form.linkedin" />
                    </div>

                    <div class="col-span-3 flex flex-col gap-1" wire:ignore>
                    ...
                    <div class="col-span-3 flex flex-col gap-1">
                        ...
                        <x-select :value="old('form.employee_range_id')" :options="$employee_ranges" class="block w-full" default="Select Employee Range..." id="employee_range_id" name="employee_range_id" required wire:model.defer="form.employee_range_id"></x-select>
                    ...
                    <div class="col-span-6 flex flex-col gap-1">
                        ...
                        <x-textarea :required="$this->required('form.certifications')" :placeholder="$this->label('form.certifications')" class="block w-full" id="certifications" name="certifications" rows="5" type="text" wire:model.defer="form.certifications" />
