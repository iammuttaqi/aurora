                ...
                <div class="inline-block min-w-full p-1.5 align-middle">
                    <div class="overflow-hidden rounded-lg border dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <div class="flex items-start gap-10">
                                                <div class="text-left">
                                                    ...
                                                    <ul class="ml-4 mt-2 list-disc">
                                                        <li class="text-sm text-gray-400">Total Sold Products: <strong class="text-gray-800 dark:text-white">{{ $sold_products->total() }}</strong></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="10">{{ $sold_products->links('components.pagination-livewire') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
