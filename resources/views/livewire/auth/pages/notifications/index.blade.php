                            ...
                            <div class="divide-y divide-gray-200 rounded-lg border dark:divide-gray-700 dark:border-gray-700">
                                <div class="flex items-center justify-between px-4 py-3">
                                    ...
                                    <div class="inline-flex gap-3 rounded-md shadow-sm" x-cloak x-show="checks.length" x-transition>
                                        <button class="inline-flex items-center justify-center gap-2 rounded-md border border-transparent bg-green-500 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" type="button" wire:click="mark(1)" wire:loading.attr="disabled" wire:loading.class="!bg-green-400" wire:target="mark">
                                            Mark As Read
                                        </button>
                                        <button class="inline-flex items-center justify-center gap-2 rounded-md border border-transparent bg-yellow-500 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" type="button" wire:click="mark(0)" wire:loading.attr="disabled" wire:loading.class="!bg-yellow-400" wire:target="mark">
                                            Mark As Unread
                                        </button>
                                    </div>
                                </div>
