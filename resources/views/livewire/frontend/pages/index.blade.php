...
<div>
    <!-- Hero -->
    <section class="relative overflow-hidden before:absolute before:left-1/2 before:top-0 before:-z-[1] before:h-full before:w-full before:-translate-x-1/2 before:transform before:bg-[url('../svg/component/polygon.svg')] before:bg-cover before:bg-top before:bg-no-repeat dark:before:bg-[url('../svg/component/polygon-dark.svg')]">
        <div class="mx-auto max-w-[85rem] px-4 py-[10rem] sm:px-6 lg:px-8">
            <!-- Announcement Banner -->
            <div class="flex justify-center">
                <a class="inline-flex items-center gap-x-2 rounded-full border border-gray-200 bg-white p-1 pl-3 text-sm text-gray-800 transition hover:border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:border-gray-600" href="#">
                    Beta Release - Join to waitlist
                    <span class="inline-flex items-center justify-center gap-x-2 rounded-full bg-gray-200 px-3 py-2 text-sm font-semibold text-gray-600 dark:bg-gray-700 dark:text-gray-400">
            ...
            <div class="mx-auto mt-5 max-w-5xl text-center">
                <h1 class="block text-4xl font-bold text-gray-800 dark:text-gray-200 md:text-5xl lg:text-6xl">
                    Managing
            ...
            <div class="mx-auto mt-5 max-w-3xl text-center">
                <p class="text-lg text-gray-600 dark:text-gray-400">Empowering Manufacturers, Shops, and Customers to Seamlessly Track Product Ownership and Warranty Information. Join Us in Creating a Transparent and Trustworthy Marketplace.</p>
            </div>
    ...
    <!-- Icon Blocks -->
    <section class="mx-auto max-w-[85rem] bg-gray-50 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <!-- Grid -->
        <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
            <!-- Icon Block -->
            <div class="flex h-36 flex-col justify-center rounded-xl border border-gray-200 bg-white p-4 text-center dark:border-gray-700 sm:h-56 md:p-5">
                <!-- Icon -->
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-br from-blue-600 to-violet-600">
                    <svg class="h-7 w-7 text-white" fill="currentColor" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mt-3">
                    <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-200 sm:text-base sm:text-lg">
                        Creative minds
                    </h3>
                </div>
            </div>
            ...
            <div class="flex h-36 flex-col justify-center rounded-xl border border-gray-200 bg-white p-4 text-center dark:border-gray-700 sm:h-56 md:p-5">
                ...
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-br from-blue-600 to-violet-600">
                    <svg class="h-7 w-7 text-white" fill="currentColor" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                        <path d="m8 2.42-.717-.737c-1.13-1.161-3.243-.777-4.01.72-.35.685-.451 1.707.236 3.062C4.16 6.753 5.52 8.32 8 10.042c2.479-1.723 3.839-3.29 4.491-4.577.687-1.355.587-2.377.236-3.061-.767-1.498-2.88-1.882-4.01-.721L8 2.42Zm-.49 8.5c-10.78-7.44-3-13.155.359-10.063.045.041.089.084.132.129.043-.045.087-.088.132-.129 3.36-3.092 11.137 2.624.357 10.063l.235.468a.25.25 0 1 1-.448.224l-.008-.017c.008.11.02.202.037.29.054.27.161.488.419 1.003.288.578.235 1.15.076 1.629-.157.469-.422.867-.588 1.115l-.004.007a.25.25 0 1 1-.416-.278c.168-.252.4-.6.533-1.003.133-.396.163-.824-.049-1.246l-.013-.028c-.24-.48-.38-.758-.448-1.102a3.177 3.177 0 0 1-.052-.45l-.04.08a.25.25 0 1 1-.447-.224l.235-.468ZM6.013 2.06c-.649-.18-1.483.083-1.85.798-.131.258-.245.689-.08 1.335.063.244.414.198.487-.043.21-.697.627-1.447 1.359-1.692.217-.073.304-.337.084-.398Z" fill-rule="evenodd" />
                    </svg>
                </div>
                <!-- End Icon -->
            ...
            <div class="flex h-36 flex-col justify-center rounded-xl border border-gray-200 bg-white p-4 text-center dark:border-gray-700 sm:h-56 md:p-5">
                ...
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-br from-blue-600 to-violet-600">
                    <svg class="h-7 w-7 text-white" fill="currentColor" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 0a.5.5 0 0 1 .447.276L8.81 1h4.69A1.5 1.5 0 0 1 15 2.5V11h.5a.5.5 0 0 1 0 1h-2.86l.845 3.379a.5.5 0 0 1-.97.242L12.11 14H3.89l-.405 1.621a.5.5 0 0 1-.97-.242L3.36 12H.5a.5.5 0 0 1 0-1H1V2.5A1.5 1.5 0 0 1 2.5 1h4.691l.362-.724A.5.5 0 0 1 8 0ZM2 11h12V2.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5V11Zm9.61 1H4.39l-.25 1h7.72l-.25-1Z" fill-rule="evenodd" />
                    </svg>
                </div>
                <!-- End Icon -->
    ...
    <section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div class="flex items-center justify-center">
            <label class="mr-3 min-w-[3.5rem] text-sm text-gray-500 dark:text-gray-400">Monthly</label>

            <input checked class="relative h-7 w-[3.25rem] shrink-0 cursor-pointer appearance-none rounded-full border border-2 border-transparent border-transparent bg-gray-100 ring-1 ring-transparent ring-offset-white transition-colors duration-200 ease-in-out before:inline-block before:h-6 before:w-6 before:translate-x-0 before:transform before:rounded-full before:bg-white before:shadow before:ring-0 before:transition before:duration-200 before:ease-in-out checked:bg-blue-600 checked:bg-none checked:before:translate-x-full checked:before:bg-blue-200 focus:border-blue-600 focus:outline-none focus:ring-blue-600 dark:bg-gray-700 dark:before:bg-gray-400 dark:checked:bg-blue-600 dark:checked:before:bg-blue-200 dark:focus:ring-offset-gray-800" id="hs-basic-with-description" type="checkbox">

            <label class="relative ml-3 min-w-[3.5rem] text-sm text-gray-500 dark:text-gray-400">
                Annual
                <span class="absolute -right-28 -top-10 left-auto">
                    <span class="flex items-center">
                        <svg class="-mr-6 h-8 w-14" fill="none" height="25" viewBox="0 0 45 25" width="45" xmlns="http://www.w3.org/2000/svg">
                            <path class="fill-gray-300 dark:fill-gray-700" d="M43.2951 3.47877C43.8357 3.59191 44.3656 3.24541 44.4788 2.70484C44.5919 2.16427 44.2454 1.63433 43.7049 1.52119L43.2951 3.47877ZM4.63031 24.4936C4.90293 24.9739 5.51329 25.1423 5.99361 24.8697L13.8208 20.4272C14.3011 20.1546 14.4695 19.5443 14.1969 19.0639C13.9242 18.5836 13.3139 18.4152 12.8336 18.6879L5.87608 22.6367L1.92723 15.6792C1.65462 15.1989 1.04426 15.0305 0.563943 15.3031C0.0836291 15.5757 -0.0847477 16.1861 0.187863 16.6664L4.63031 24.4936ZM43.7049 1.52119C32.7389 -0.77401 23.9595 0.99522 17.3905 5.28788C10.8356 9.57127 6.58742 16.2977 4.53601 23.7341L6.46399 24.2659C8.41258 17.2023 12.4144 10.9287 18.4845 6.96211C24.5405 3.00476 32.7611 1.27399 43.2951 3.47877L43.7049 1.52119Z" fill="currentColor" />
                        </svg>
                        <span class="mt-3 inline-block whitespace-nowrap rounded-full bg-blue-600 px-2.5 py-1 text-[11px] font-semibold uppercase leading-5 tracking-wide text-white">Save up to 10%</span>
                    </span>
                </span>
            </label>
        </div>
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:items-center">
            ...
            <div class="flex flex-col rounded-xl border border-gray-200 p-8 text-center dark:border-gray-700">
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Free</h4>
                <span class="mt-7 text-5xl font-bold text-gray-800 dark:text-gray-200">Free</span>
                <p class="mt-2 text-sm text-gray-500">Forever free</p>

                <ul class="mt-7 space-y-2.5 text-sm">
                    <li class="flex space-x-2">
                        <svg class="h-5 w-5 flex-shrink-0 text-blue-600" fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="mt-5 inline-flex items-center justify-center gap-2 rounded-md border-2 border-blue-600 px-4 py-3 text-sm font-semibold text-blue-600 transition-all hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-blue-600 dark:text-blue-500 dark:hover:border-blue-700" href="#">
                    Sign up
                </a>
            </div>
            <!-- End Card -->
            ...
            <div class="flex flex-col rounded-xl border-2 border-blue-600 p-8 text-center shadow-xl dark:border-blue-700">
                <p class="mb-3"><span class="inline-flex items-center gap-1.5 rounded-md bg-blue-100 px-3 py-1.5 text-xs font-semibold uppercase text-blue-800 dark:bg-blue-600 dark:text-white">Most popular</span></p>
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Startup</h4>
                <span class="mt-5 text-5xl font-bold text-gray-800 dark:text-gray-200">
                ...
                <a class="mt-5 inline-flex items-center justify-center gap-x-3 rounded-md bg-blue-600 px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-blue-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800" href="https://github.com/htmlstreamofficial/preline/tree/main/examples/html">
                    Sign up
                </a>
            </div>
            <!-- End Card -->
            ...
            <!-- Card -->
            <div class="flex flex-col rounded-xl border border-gray-200 p-8 text-center dark:border-gray-700">
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Team</h4>
                <span class="mt-5 text-5xl font-bold text-gray-800 dark:text-gray-200">
                    <span class="-mr-2 text-2xl font-bold">$</span>
                    89
                </span>
            ...
            <!-- Card -->
            <div class="flex flex-col rounded-xl border border-gray-200 p-8 text-center dark:border-gray-700">
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Enterprise</h4>
                <span class="mt-5 text-5xl font-bold text-gray-800 dark:text-gray-200">
                    <span class="-mr-2 text-2xl font-bold">$</span>
                    149
                </span>
    ...
    <section class="mx-auto max-w-[85rem] bg-gray-50 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <!-- Title -->
        <div class="mx-auto mb-10 max-w-2xl text-center lg:mb-14">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 md:text-3xl md:leading-tight">
    ...
    <section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <!-- Card -->
            <div class="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-slate-900">
                <div class="flex-auto p-4 md:p-6">
                    <svg class="h-auto w-20 text-gray-700 dark:text-gray-300 sm:w-24" fill="none" height="47" viewBox="0 0 140 47" width="140" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="mt-3 text-base text-gray-800 dark:text-white sm:mt-6 md:text-xl"><em>
                ...
                <div class="rounded-b-xl p-4 md:px-6">
                    <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-200 sm:text-base">
                        Nicole Grazioso
                    </h3>
            ...
            <div class="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-slate-900">
                <div class="flex-auto p-4 md:p-6">
                    <svg class="h-auto w-20 text-gray-700 dark:text-gray-300 sm:w-24" fill="none" height="67" viewBox="0 0 200 67" width="200" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-slate-900">
                <div class="flex-auto p-4 md:p-6">
                    <svg class="h-auto w-20 text-gray-700 dark:text-gray-300 sm:w-24" fill="none" height="47" viewBox="0 0 140 47" width="140" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <clipPath id="clip0">
                                <rect fill="white" height="47" width="140"></rect>
                            </clipPath>
                        </defs>
                    </svg>
            ...
            <div class="lg:col-span-4">
                ...
                <div class="lg:pr-6 xl:pr-12">
                    <p class="text-6xl font-bold leading-10 text-blue-500">
                        92%
                        <span class="ml-1 inline-flex items-center gap-x-1 rounded-full bg-gray-200 px-2 py-0.5 text-xs font-medium leading-4 text-gray-800 dark:bg-gray-800 dark:text-gray-300">
                            <svg class="h-3 w-3" fill="currentColor" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z" />
                            </svg>
                            +7% this month
                        </span>
                    </p>
                    <p class="mt-2 text-gray-500 sm:mt-3">of U.S. adults have bought from businesses using Space</p>
                </div>
                <!-- End Stats -->
            </div>
            <!-- End Col -->

            <div class="relative lg:col-span-8 lg:before:absolute lg:before:-left-12 lg:before:top-0 lg:before:h-full lg:before:w-px lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
        ...
        <div class="mx-auto max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="grid justify-center gap-2 md:grid-cols-2 md:items-center md:justify-between">
                <div class="text-center md:text-left">
                    <p class="text-xs uppercase tracking-wider text-white/[.8]">
                        Preview of Preline
                    </p>
                ...
                <div class="mt-3 text-center md:flex md:items-center md:justify-end md:text-left">
                    <a class="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 align-middle text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white" href="#">
                        Sign up free
                    </a>
                </div>
                <!-- End Col -->
    ...
    <section class="mx-auto max-w-[85rem] bg-gray-50 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div class="mx-auto mb-6 text-center sm:w-1/2 md:mb-12 xl:w-1/3">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 md:text-2xl md:leading-tight">Trusted by Open Source, enterprise, and more than 99,000 of you</h2>
        </div>
        <!-- End Title -->

        <!-- Grid -->
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5 lg:gap-6">
            <div class="rounded-lg bg-gray-100 p-4 dark:bg-slate-800 md:p-7">
                <svg class="mx-auto h-auto w-16 py-3 text-gray-800 dark:text-gray-200 md:w-20 lg:w-24 lg:py-5" enable-background="new 0 0 2499 614" viewBox="0 0 2499 614" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="rounded-lg bg-gray-100 p-4 dark:bg-slate-800 md:p-7">
                <svg class="mx-auto h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5" height="534" viewBox="0 0 1033.746 220.695" width="2500" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="rounded-lg bg-gray-100 p-4 dark:bg-slate-800 md:p-7">
                <svg class="mx-auto h-auto w-16 py-3 text-gray-800 dark:text-gray-200 md:w-20 lg:w-24 lg:py-5" height="607" viewBox="-4.126838974812941 0.900767442746961 939.436838974813 230.18142889845947" width="2500" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="rounded-lg bg-gray-100 p-4 dark:bg-slate-800 md:p-7">
                <svg class="mx-auto h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5" height="1036" viewBox="0 -6.166 294.398 121.975" width="2500" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M233.712 78.636c11.72-15.086 20.938-32.809 20.938-45.537 0-6.652-4.765-11.295-10.978-14.823.123 13.831-4.668 46.263-9.96 60.36M195.279 115.809c27.47-9.188 67.29-30.598 94.985-49.725 2.324-1.6 4.135-3.085 4.135-5.685 0-4.519-8.275-10.576-12.292-12.987-21.792 22.653-65.163 56.596-86.828 68.397" fill="#ffdd05" />
                    <path d="M220.76 96.567c16.938-11.709 41.545-33.739 49.873-45.727 1.963-2.82 3.416-4.454 3.416-7.405 0-4.839-5.644-8.382-9.703-10.849-9.727 22.924-31.579 51.469-43.586 63.981M236.192 64.087c2.191-14.477.903-31.952-1.894-42.913-1.521-5.969-6.901-12.706-11.88-14.812 6.526 18.522 12.128 44.898 13.774 57.725" fill="#ffdd05" />
                    <path d="M231.367 43.779C226.235 29.91 213.446.998 194.633-6.165c12.247 13.516 30.417 40.337 36.734 49.944" fill="#ffdd05" />
                </svg>
            </div>

            <div class="rounded-lg bg-gray-100 p-4 dark:bg-slate-800 md:p-7">
                <svg class="mx-auto h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5" fill="none" viewBox="0 0 2500 816" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#a)">
                        <path d="M307.9 0H330a303.4 303.4 0 0 1 207.7 87.7c-20.2 20.6-40.7 40.3-60.5 60.9-30.6-27.7-67.5-49.1-107.8-56.7A227.9 227.9 0 0 0 196 124.7a227.3 227.3 0 0 0-99.4 160.6 233.5 233.5 0 0 0 50.7 180.4 224.5 224.5 0 0 0 163.6 80.5c58.7 3.4 120-14.7 162.8-55.8 33.5-29 49-73 54-115.7-69.5 0-139.2.4-208.8 0v-86.5H612c15.1 92.7-6.7 197.2-77.2 263.5-47 47-112 74.6-178.3 80A327.4 327.4 0 0 1 169 595 322.8 322.8 0 0 1 19.3 424a309.3 309.3 0 0 1-2.1-209.3 319.4 319.4 0 0 1 115.4-153A329.3 329.3 0 0 1 307.9 0Z" fill="#3780FF" />
                        <path d="M1990 21.9h89.7v599c-29.8 0-60 .4-89.8-.4.4-199.3 0-399 0-598.6Z" fill="#38B137" />
                        <path d="M811.7 229.5a210.8 210.8 0 0 1 161 34.4 197 197 0 0 1 79.3 125.9c11.3 58.3-3 122-40.7 168.2A205 205 0 0 1 839 633a204.1 204.1 0 0 1-152.7-81.8c-39.8-53.6-49.5-127.5-27.6-190.4 21.8-67.5 83.4-119.1 153-131.3Zm12.5 79.7a112.8 112.8 0 0 0-58.7 37.3c-40.7 48.7-38.2 128 6.7 173.3a111.7 111.7 0 0 0 177.9-26.4c27.7-50 19.7-118.7-22.7-157.8a113.2 113.2 0 0 0-103.2-26.4Z" fill="#FA3913" />
                        <path d="M1256.3 229.5c63.3-12.1 132.5 5.5 180 50 77.1 69.1 85.5 198.8 19.7 278.5a204.7 204.7 0 0 1-168.3 75 202.6 202.6 0 0 1-156.8-81.8c-40.7-54.9-49.5-130.4-26.5-194.6a199.2 199.2 0 0 1 151.9-127Zm12.6 79.7a114.7 114.7 0 0 0-58.8 37c-40.2 47.7-38.5 125.8 4.7 171.5a112.2 112.2 0 0 0 102.3 33.1 115 115 0 0 0 78-57.4c27.3-50.4 19.3-119.2-23.5-158.2a112.4 112.4 0 0 0-102.7-26Z" fill="#FCBD06" />
                        <path d="M1633.4 253.8c48.2-30.2 112.4-38.5 164.4-12.5 16.4 7 29.8 19.3 42.8 31.4.4-11.3 0-23 .4-34.8 28.1.4 56.2 0 84.8.4v370c-.5 55.8-14.7 115-55 155.6-44 44.9-111.6 58.7-172.4 49.5-65-9.6-121.6-57-146.8-117 25.2-12.2 51.6-21.8 77.6-33.2 14.7 34.4 44.5 63.8 81.8 70.5 37.3 6.7 80.5-2.5 104.9-33.5 26-32 26-75.5 24.7-114.6-19.3 19-41.5 35.7-68.4 42-58.3 16.3-122.5-3.8-167.3-43.2a205.5 205.5 0 0 1-69.7-160.7 207.4 207.4 0 0 1 98.2-169.9Zm86.8 53.7a110.4 110.4 0 0 0-65.8 38.2c-39.5 47-39.5 122 .4 168.2a109.8 109.8 0 0 0 94.4 38.6 106.6 106.6 0 0 0 80-53.3c27.8-49 23.1-115.7-14.2-158.5-23-26.4-60-39.5-94.8-33.2Z" fill="#3780FF" />
                        <path d="M2187.5 275.2c50.3-47 128-62.9 192.5-38.1 61.3 23 100.3 81.3 120 141.3-91 37.8-181.6 75.1-272.7 112.9 12.6 23.9 32 45.7 58 54.5 36.4 13 80 8.4 110.7-16a178.1 178.1 0 0 0 31-33c23 15.4 46.2 30.5 69.2 46a202 202 0 0 1-146.8 89c-65.4 8-135-17.2-177.4-68.4-69.7-80.5-63-215.6 15.5-288.2Zm44.9 77.6a119.8 119.8 0 0 0-19.7 70.5 33573 33573 0 0 0 182.4-76c-10-23.4-34.4-37.7-59.1-41.4-39.9-7.2-81.4 14.2-103.6 47Z" fill="#FA3913" />
                    </g>
                    <defs>
                        <clipPath id="a">
                            <path d="M0 0H2500V816H0z" fill="#fff" />
                        </clipPath>
                    </defs>
                </svg>
            </div>
