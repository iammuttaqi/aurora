...
class Profile extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'form.about'                      => ['required', 'string', 'max:255'],
            ...
            'form.business_license'           => ['nullable', 'string', 'max:255'],
            'form.vat_number'                 => ['nullable', 'string', 'max:255'],
            'form.payment_terms'              => ['nullable', 'string', 'max:255'],
            'form.shipping_options'           => ['nullable', 'string', 'max:255'],
            'form.additional_information'     => ['nullable', 'string', 'max:255'],
            'form.general_manager_name'       => ['nullable', 'string', 'max:255'],
            'form.general_manager_email'      => ['nullable', 'string', 'max:255'],
            'form.sales_manager_name'         => ['nullable', 'string', 'max:255'],
            'form.sales_manager_email'        => ['nullable', 'string', 'max:255'],
            'form.hr_manager_name'            => ['nullable', 'string', 'max:255'],
            'form.hr_manager_email'           => ['nullable', 'string', 'max:255'],
            'form.it_manager_name'            => ['nullable', 'string', 'max:255'],
            'form.it_manager_email'           => ['nullable', 'string', 'max:255'],
